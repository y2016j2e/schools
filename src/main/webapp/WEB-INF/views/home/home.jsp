...
<link href="resources/css/homestyle.css" type="text/css" rel="stylesheet" />
<link href="resources/font-awesome-4.1.0/css/font-awesome.css" type="text/css" rel="stylesheet" />
...
<div id="content">
 ...
 <div class="main">
    ...
    <div class="box1 row">
	<div class="center">
    	<a href="#" class="box"><div><i class="fa fa-2x fa-university inside"></i></div><div class="space"> Thông tin nhà trường</div></a>
        <a href="#" class="box"><div><i class="fa fa-2x fa-users inside"></i></div><div class="space">Danh sách đội ngũ</div></a>
        <a href="/schools/lop" class="box"><div><i class="fa fa-2x fa-th-large inside"></i></div><div class="space">Danh mục lớp học</div></a>
